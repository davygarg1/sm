...
function Register(props) {
    ...
    return (
        <>
            ...
            <div className="bg-red-100 w-screen h-screen flex items-center justify-center overflow-x-hidden">
                ...
                <div className='h-full w-full flex items-center justify-center'>
                    ...
                    <div className='w-[80%] h-[35rem] md:h-full md:w-3/6 border-808080 flex flex-col items-center justify-center bg-white overflow-y-hidden' style={{ "boxShadow": "0px 0px 50px #000000" }}>
                        ...
                        <div className='w-full overflow-y-scroll p-10 md:px-20' style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                            ...
                            <h1 className='font-bold mb-12 mt-2 font-mono'>Welcome</h1>
                            ...
                            <Form className='w-68 h-68 overflow-hidden' form={form} layout="vertical" initialValues={{ requiredMarkValue: requiredMark, remember: true, }}
                                ...
                                <Form.Item label="Name" name="Name" required tooltip="This is a required field" rules={[{ required: true, message: 'Please enter your Name!', },]}>
                                    <Input placeholder="input Your Name" type='string' maxLength={15} />
                                </Form.Item>

                                <Form.Item label="Email" name="Email" required tooltip="This is a required field" rules={[{ required: true, message: 'Please enter your Email!', },]}>
                                    <Input placeholder="input Your Email" type='email' />
                                </Form.Item>

                                <Form.Item label="Phone" name="Phone" required tooltip="This is a required field" rules={[{ required: true, message: 'Please enter your Phone!', },]}>
                                    <Input placeholder="input Your Phone" type='number' maxLength={10} />
                                </Form.Item>

                                <Form.Item label="Age" name="Age" required tooltip="This is a required field" rules={[{ required: true, message: 'Please enter your Age!', },]}>
                                    <Input placeholder="input Your Age" type='number' maxLength={2} />
                                </Form.Item>
